...
print(f"P_bg.K: {P_bg.K} / P_obj.K: {P_obj.K}")
print(f"{P_bg.P @ np.array([0, 0, 0, 1]) / (P_bg.P @ np.array([0, 0, 0, 1]))[-1]}")
print(f"{P_obj.P @ np.array([0, 0, 0, 1]) / (P_obj.P @ np.array([0, 0, 0, 1]))[-1]}")
